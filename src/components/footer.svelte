<footer class="p-4 sm:p-6" id="footer">
    <div class="mx-auto max-w-screen-xl">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm sm:text-center text-gray-400">© 2022 <a href="https://nextdigitalcompany.com" class="hover:underline">Next Digital Company™</a>. All Rights Reserved.
            </span>
